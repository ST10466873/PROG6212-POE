...
/* =====================================================================================
   ...
   Part 2 video demonstrate both the "enter an event" and "capture a result" flows.
   ...
   the demo data stable between runs.
   ===================================================================================== */
...
INSERT INTO dbo.Users (UserId, RoleId, FirstName, LastName, Email, PasswordHash, PhoneNumber, DateOfBirth, IsActive, CreatedAt) VALUES
    ...
    (5, 2, N'Naledi',  N'Sithole', N'naledi.sithole@outlook.com',    N'$2a$11$PLACEHOLDERHASH000000000000000000000000000000000004', N'074 555 0166', N'2005-01-30', 1, N'2026-06-12 12:05:00'),  -- participant, qualifies for Under 20? No - see category notes below
